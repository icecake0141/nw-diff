...
- [ ] Runtime env and auth policy are set for production (`NW_DIFF_ENV=production` and `NW_DIFF_API_TOKEN`)
...
Tests cover:
- Application routes and authentication logic (v1 and v2)
...
The full Japanese documentation is maintained in `docs/README_ja.md`.

To keep this README focused and avoid drift, the embedded Japanese translation section has been removed.
